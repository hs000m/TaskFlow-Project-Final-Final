...
// FIX: Add AlertTriangleIcon to the import list.
import { KanbanIcon, ListIcon, CalendarIcon, PlusIcon, SettingsIcon, UserXIcon, XIcon, SparklesIcon, CalendarCheckIcon, LoaderIcon, SearchIcon, AlertTriangleIcon } from '../components/icons';
...
const TaskFlowPage: React.FC<TaskFlowPageProps> = ({ currentUser, companies, setCompanies, employees, setEmployees }) => {
    ...
    const handleUpdateDashboardAccess = (employeeId: string, canAccess: boolean) => {
        setEmployees(prev =>
            prev.map(e => (e.id === employeeId ? { ...e, canViewDashboard: canAccess } : e))
        );
    };
        ...
        <>
                ...
                <div className="px-6">
                    <div className="flex items-center justify-between h-16">
                        <div className="flex items-center">
                            <h1 className="text-2xl font-bold text-slate-900 dark:text-white ml-2">Task Dashboard</h1>
                        </div>
                        <div className="flex items-center space-x-4">
                            ...
                            {(currentUser.role === Role.CEO || currentUser.role === Role.Admin) && (
                                <button onClick={() => setIsManagementModalOpen(true)} className="p-2 rounded-full text-slate-500 dark:text-slate-400 hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors" title="Management">
            ...
            {isManagementModalOpen && (
                <ManagementModal
                    ...
                    onUpdateDashboardAccess={handleUpdateDashboardAccess}
                />
            )}
